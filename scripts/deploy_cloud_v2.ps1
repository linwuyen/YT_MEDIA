...
# Do not use status filters here. On a machine with no gcloud account yet,
# Windows PowerShell 5.1 can promote gcloud's harmless stderr warning into a
# NativeCommandError. An empty account list simply means we should log in.
